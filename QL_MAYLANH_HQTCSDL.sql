...
(
	...
	MAQUYEN VARCHAR(10),
	FOREIGN KEY (MAQUYEN) REFERENCES QUYEN(MAQUYEN)ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
	...
	FOREIGN KEY (MAHDX) REFERENCES HOADONXUAT(MAHDX)ON DELETE CASCADE ON UPDATE CASCADE,
...
('SP001', N'Máy lạnh Daikin Inverter 1HP', 50, 7000000, 9500000, 'DAI'),
('SP002', N'Máy lạnh Panasonic 1.5HP', 30, 8500000, 12000000, 'PANA'),
('SP003', N'Máy lạnh LG Dual Cool Inverter', 40, 7600000, 10500000, 'LG'),
('SP004', N'Máy lạnh Samsung Wind-Free 1.5HP', 25, 8800000, 12500000, 'SS'),
('SP005', N'Máy lạnh Mitsubishi Heavy Inverter 2HP', 20, 12000000, 15500000, 'MIT'),
('SP006', N'Máy lạnh Toshiba Inverter 1HP', 40, 7200000, 9800000, 'TOYO'),
('SP007', N'Máy lạnh Fujitsu 1.5HP', 35, 8200000, 11300000, 'FUJI'),
('SP008', N'Máy lạnh Hitachi Inverter 1HP', 30, 7300000, 9900000, 'HIT'),
('SP009', N'Máy lạnh Sharp J-Tech Inverter', 20, 8500000, 12500000, 'SHARP'),
('SP010', N'Máy lạnh Gree Inverter 1.5HP', 25, 7600000, 10200000, 'GREE');
...
('CTHDN001', 'HDN001', 'SP001', 10, 7000000),
('CTHDN002', 'HDN002', 'SP002', 3, 8500000),
('CTHDN003', 'HDN003', 'SP003', 4, 7600000),
('CTHDN004', 'HDN004', 'SP004', 2, 8800000),
('CTHDN005', 'HDN005', 'SP005', 2, 12000000),
('CTHDN006', 'HDN006', 'SP006', 10, 7200000),
('CTHDN007', 'HDN007', 'SP007', 5, 8200000),
('CTHDN008', 'HDN008', 'SP008', 4, 7300000),
('CTHDN009', 'HDN009', 'SP009', 2, 8500000),
('CTHDN010', 'HDN010', 'SP010', 5, 7600000);

INSERT INTO HOADONXUAT (MAHDX, MAKH, MANV, TONGTIEN, NGAY) VALUES
('HDX001', 'KH001', 'NV001', 19000000, '2024-10-15'),
('HDX002', 'KH002', 'NV002', 36000000, '2024-10-16'),
('HDX003', 'KH003', 'NV003', 21000000, '2024-10-17'),
('HDX004', 'KH004', 'NV004', 12500000, '2024-10-18'),
('HDX005', 'KH005', 'NV005', 31000000, '2024-10-19'),
('HDX006', 'KH006', 'NV006', 19600000, '2024-10-20'),
('HDX007', 'KH007', 'NV007', 22600000, '2024-10-21'),
('HDX008', 'KH008', 'NV008', 9900000, '2024-10-22'),
('HDX009', 'KH009', 'NV009', 12500000, '2024-10-23'),
('HDX010', 'KH010', 'NV010', 20400000, '2024-10-24');


INSERT INTO CHITIETHOADONXUAT (MACTHDX, MAHDX, MASANPHAM, SOLUONG, DONGIA) VALUES
('CTHDX001', 'HDX001', 'SP001', 2, 9500000),
('CTHDX002', 'HDX002', 'SP002', 3, 1200000),
('CTHDX003', 'HDX003', 'SP003', 2, 10500000),
('CTHDX004', 'HDX004', 'SP004', 1, 12500000),
('CTHDX005', 'HDX005', 'SP005', 2, 15500000),
('CTHDX006', 'HDX006', 'SP006', 2, 9800000),
('CTHDX007', 'HDX007', 'SP007', 1, 11300000),
('CTHDX008', 'HDX008', 'SP008', 1, 9900000),
('CTHDX009', 'HDX009', 'SP009', 1, 12500000),
('CTHDX010', 'HDX010', 'SP010', 2, 10200000);
